...
const HeroSec = () => {
 ...
 block md:hidden
        ...
        <div className="absolute inset-0 bg-linear-to-t from-black via-transparent to-transparent opacity-80 z-0" />
        ...
        >
          <div className="flex flex-col items-center md:items-end text-center md:text-right">
            ...
            <div className="flex items-center justify-center md:justify-end gap-3 mb-4">
              <div className="h-px w-6 sm:w-8 bg-linear-to-r from-transparent to-white/50" />
              <p
                className="
                text-white
                uppercase
